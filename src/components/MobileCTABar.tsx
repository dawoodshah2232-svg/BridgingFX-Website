      ...
      {visible && (
        ...
        >
          <div className="glass flex items-center gap-2.5 rounded-2xl p-2.5 shadow-card">
            <Link
              href="/contact"
              className="btn-primary min-h-[48px] flex-1 !px-4 !py-3 !text-sm"
            >
              Get a Quote
            </Link>
            <a
              ...
              className="flex min-h-[48px] min-w-[48px] items-center justify-center rounded-full border border-white/15 bg-white/5"
            >
